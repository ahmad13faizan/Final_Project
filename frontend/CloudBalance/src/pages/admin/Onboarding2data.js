// This file contains the policy document for the IAM role used in the AWS S3 replication process.
// The policy document grants permissions for various actions related to AWS Cost and Usage Reports (CUR) and S3 replication.
// The policy includes permissions for reading CUR data, listing and getting S3 objects, and replicating objects between S3 buckets.
// The policy is structured in JSON format and includes specific actions, resources, and effects for each statement.
// The policy is designed to allow the necessary permissions for the CK Tuner application to function correctly with AWS S3 and CUR.
